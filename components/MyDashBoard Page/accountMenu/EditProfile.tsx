        ...
        <div role='email-nickname-input-container' className='flex flex-col gap-5'>
          ...
          <div role='email-box' className='flex flex-col gap-2.5'>
            ...
            <input
              ...
              disabled={true}
              className='p-4 w-[22.875rem] rounded-md border border-solid border-tp-gray_700 text-tp-gray_700 disabled:bg-white'
            />
          </div>
          ...
          <button
            ...
            className='py-2.5 px-8 border border-solid border-tp-gray_700 rounded-lg self-end bg-tp-violet_900 text-white active:bg-violet-900'>
            저장
          </button>
        </div>
      </form>
